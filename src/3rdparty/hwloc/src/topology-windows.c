                                 ...
                                 unsigned value)
{
  ...
  if (classes->nr_classes == classes->nr_classes_allocated) {
    ...
    if (!new_nr_allocated) {
#define HWLOC_WIN_EFFICIENCY_CLASSES_DEFAULT_MAX 4 
 ...
 out:
  ...
  if (osvi.dwMajorVersion == 10) {
    ...
    if (osvi.dwMinorVersion == 3)
      hwloc_obj_add_info(topology->levels[0][0], "OSRelease", "8.1"); 
    else if (osvi.dwMinorVersion == 2)
      hwloc_obj_add_info(topology->levels[0][0], "OSRelease", "8"); 
    else if (osvi.dwMinorVersion == 1)
      hwloc_obj_add_info(topology->levels[0][0], "OSRelease", "7"); 
    else if (osvi.dwMinorVersion == 0)
      hwloc_obj_add_info(topology->levels[0][0], "OSRelease", "Vista"); 
  } 
			...
			struct hwloc_topology_support *support)
{
  ...
  if (QueryWorkingSetExProc && max_numanode_index <= 63 )
