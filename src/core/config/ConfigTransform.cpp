...
#   ifdef XMRIG_FEATURE_BENCHMARK
    ...
    case IConfig::BenchKey:         
    case IConfig::StressKey:        
    case IConfig::BenchSubmitKey:   
    case IConfig::BenchVerifyKey:   
    case IConfig::BenchTokenKey:    
    case IConfig::BenchSeedKey:     
    case IConfig::BenchHashKey:     
    case IConfig::UserKey:          
    case IConfig::RotationKey:      
